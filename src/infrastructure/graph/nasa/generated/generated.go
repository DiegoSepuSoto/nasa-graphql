...
type ComplexityRoot struct {
	...
	Photo struct {
		...
		Rover  func(childComplexity int) int
	}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Photo.camera":
		if e.complexity.Photo.Camera == nil {
			break
		}

		return e.complexity.Photo.Camera(childComplexity), true

	case "Photo.date":
		if e.complexity.Photo.Date == nil {
			break
		}

		return e.complexity.Photo.Date(childComplexity), true

	case "Photo.link":
		if e.complexity.Photo.Link == nil {
			break
		}

		return e.complexity.Photo.Link(childComplexity), true

	case "Photo.rover":
		if e.complexity.Photo.Rover == nil {
			break
		}

		return e.complexity.Photo.Rover(childComplexity), true
	...
	case "Rover.id":
		if e.complexity.Rover.ID == nil {
			break
		}

		return e.complexity.Rover.ID(childComplexity), true

	case "Rover.name":
		if e.complexity.Rover.Name == nil {
			break
		}

		return e.complexity.Rover.Name(childComplexity), true
...
func (ec *executionContext) _Photo_link(ctx context.Context, field graphql.CollectedField, obj *model.Photo) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) _Photo_camera(ctx context.Context, field graphql.CollectedField, obj *model.Photo) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) _Rover_id(ctx context.Context, field graphql.CollectedField, obj *model.Rover) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) _Photo(ctx context.Context, sel ast.SelectionSet, obj *model.Photo) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "link":
			out.Values[i] = ec._Photo_link(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				invalids++
			}
		case "camera":
			out.Values[i] = ec._Photo_camera(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				invalids++
			}
		case "rover":
			out.Values[i] = ec._Photo_rover(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				invalids++
			}
		case "date":
			out.Values[i] = ec._Photo_date(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				invalids++
			}
		default:
...
var roverImplementors = []string{"Rover"}

func (ec *executionContext) _Rover(ctx context.Context, sel ast.SelectionSet, obj *model.Rover) graphql.Marshaler {
	fields := graphql.CollectFields(ec.OperationContext, sel, roverImplementors)
	...
	for i, field := range fields {
		switch field.Name {
		case "__typename":
			out.Values[i] = graphql.MarshalString("Rover")
		case "id":
			out.Values[i] = ec._Rover_id(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				invalids++
			}
		case "name":
			out.Values[i] = ec._Rover_name(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				invalids++
			}
		default:
